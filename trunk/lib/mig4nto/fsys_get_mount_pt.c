...
/*
 * fsys_get_mount_pt.c - QNX 4 to QNX Neutrino migration functions
 */
...
int fsys_get_mount_pt(const char *device, char *directory)
{
	...
	msg.i.devctl.zero = 0;
	if (_connect_combine(device, 0, O_ACCMODE, SH_DENYNO, 0, _FTYPE_ANY, sizeof(msg.i), &msg.i, sizeof(msg.o), &msg.o) == -1)
		return(-1);
