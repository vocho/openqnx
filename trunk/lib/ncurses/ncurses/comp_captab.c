...
static struct name_table_entry const _nc_info_table[] =
{
	...
	{           "rum",	    STRING,	327, 147 },
	{          "mhpa",	    STRING,	328, 331 },
	{         "mcud1",	    STRING,	329, 123 },
	{         "mcub1",	    STRING,	330,  -1 },
	{         "mcuf1",	    STRING,	331,  -1 },
	{          "mvpa",	    STRING,	332,  -1 },
	{         "mcuu1",	    STRING,	333,  -1 },
	{        "porder",	    STRING,	334,  24 },
	{          "mcud",	    STRING,	335, 334 },
	{          "mcub",	    STRING,	336, 332 },
	{          "mcuf",	    STRING,	337,  10 },
	{          "mcuu",	    STRING,	338, 278 },
	...
	{         "supcs",	    STRING,	351,  41 },
	{          "docr",	    STRING,	352,  -1 },
	{         "zerom",	    STRING,	353, 213 },
	{          "csnm",	    STRING,	354, 347 },
	{         "kmous",	    STRING,	355,  -1 },
	{         "minfo",	    STRING,	356, 238 },
	{         "reqmp",	    STRING,	357,  -1 },
	{          "getm",	    STRING,	358, 369 },
	{         "setaf",	    STRING,	359,  -1 },
	{         "setab",	    STRING,	360,  -1 },
...
const struct name_table_entry * const _nc_info_hash_table[991] =
{
	_nc_info_table +  59,
	_nc_info_table +  47,
	_nc_info_table +  55,
...
#if (BOOLCOUNT!=44)||(NUMCOUNT!=39)||(STRCOUNT!=412)
...
const struct name_table_entry * const _nc_cap_hash_table[991] =
{
	0,
	_nc_cap_table +  47,
	_nc_cap_table +  34,
