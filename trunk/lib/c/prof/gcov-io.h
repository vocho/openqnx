...
static int __fetch_long	(long *, char *, size_t) __attribute__((unused));
static int __read_long  (long *, FILE *, size_t) __attribute__((unused));
static int __write_long (long, FILE *, size_t) __attribute__((unused));
static int __fetch_gcov_type (gcov_type *, char *, size_t) __attribute__((unused));
static int __store_gcov_type (gcov_type, char *, size_t) __attribute__((unused));
static int __read_gcov_type (gcov_type *, FILE *, size_t) __attribute__((unused));
static int __write_gcov_type (gcov_type, FILE *, size_t) __attribute__((unused));
static int __write_gcov_string (const char *, size_t, FILE*, long) __attribute__((unused));
static int __read_gcov_string (char *, size_t, FILE*, long) __attribute__((unused));
