...
#if 0
	/* this is for inside trunk/service/montt_rtapp use only
	 * to inform tracer of the periodicity of this task
	 */
	TraceEvent(_montt_TRACE_TASKPERIODICITY, getpid(), pthread_self(), ti->sec, ti->nsec);
#endif
