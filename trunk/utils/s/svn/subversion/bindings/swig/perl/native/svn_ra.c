...
#define SWIGTYPE_p_svn_diff_datasource_e swig_types[86]
#define SWIGTYPE_p_svn_diff_file_ignore_space_t swig_types[87]
#define SWIGTYPE_p_svn_diff_file_options_t swig_types[88]
...
#define SWIGTYPE_p_svn_ra_callbacks2_t swig_types[110]
#define SWIGTYPE_p_svn_ra_callbacks_t swig_types[111]
#define SWIGTYPE_p_svn_ra_plugin_t swig_types[112]
#define SWIGTYPE_p_svn_ra_reporter2_t swig_types[113]
#define SWIGTYPE_p_svn_ra_reporter3_t swig_types[114]
#define SWIGTYPE_p_svn_ra_reporter_t swig_types[115]
#define SWIGTYPE_p_svn_ra_session_t swig_types[116]
#define SWIGTYPE_p_svn_stream_t swig_types[117]
#define SWIGTYPE_p_svn_string_t swig_types[118]
#define SWIGTYPE_p_svn_stringbuf_t swig_types[119]
...
XS(_wrap_svn_ra_lock) {
  {
    ...
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "svn_ra_lock" "', argument " "2"" of type '" "apr_hash_t *""'"); 
    }
    ...
    {
      int res = SWIG_ConvertFunctionPtr(ST(4), (void**)(&arg5), SWIGTYPE_p_f_p_void_p_q_const__char_svn_boolean_t_p_q_const__svn_lock_t_p_svn_error_t_p_apr_pool_t__p_svn_error_t);
      if (!SWIG_IsOK(res)) {
        SWIG_exception_fail(SWIG_ArgError(res), "in method '" "svn_ra_lock" "', argument " "5"" of type '" "svn_ra_lock_callback_t""'"); 
      }
    }
    res6 = SWIG_ConvertPtr(ST(5),SWIG_as_voidptrptr(&arg6), 0, 0);
    if (!SWIG_IsOK(res6)) {
      SWIG_exception_fail(SWIG_ArgError(res6), "in method '" "svn_ra_lock" "', argument " "6"" of type '" "void *""'"); 
    }
    if (items > 6) {
...
XS(_wrap_svn_ra_unlock) {
  {
    ...
    {
      int res = SWIG_ConvertFunctionPtr(ST(3), (void**)(&arg4), SWIGTYPE_p_f_p_void_p_q_const__char_svn_boolean_t_p_q_const__svn_lock_t_p_svn_error_t_p_apr_pool_t__p_svn_error_t);
      if (!SWIG_IsOK(res)) {
        SWIG_exception_fail(SWIG_ArgError(res), "in method '" "svn_ra_unlock" "', argument " "4"" of type '" "svn_ra_lock_callback_t""'"); 
      }
    }
    res5 = SWIG_ConvertPtr(ST(4),SWIG_as_voidptrptr(&arg5), 0, 0);
    if (!SWIG_IsOK(res5)) {
      SWIG_exception_fail(SWIG_ArgError(res5), "in method '" "svn_ra_unlock" "', argument " "5"" of type '" "void *""'"); 
    }
    if (items > 5) {
...
XS(SWIG_init) {
  ...
  /*@SWIG:%set_constant@*/ do {
    SV *sv = get_sv((char*) SWIG_prefix "SVN_RA_CAPABILITY_DEPTH", TRUE | 0x2);
    sv_setsv(sv, SWIG_FromCharPtr("depth"));
    SvREADONLY_on(sv);
  } while(0) /*@SWIG@*/;
  /*@SWIG:%set_constant@*/ do {
    SV *sv = get_sv((char*) SWIG_prefix "SVN_RA_CAPABILITY_MERGEINFO", TRUE | 0x2);
    sv_setsv(sv, SWIG_FromCharPtr("mergeinfo"));
    SvREADONLY_on(sv);
  } while(0) /*@SWIG@*/;
  /*@SWIG:%set_constant@*/ do {
    SV *sv = get_sv((char*) SWIG_prefix "SVN_RA_CAPABILITY_LOG_REVPROPS", TRUE | 0x2);
    sv_setsv(sv, SWIG_FromCharPtr("log-revprops"));
    SvREADONLY_on(sv);
  } while(0) /*@SWIG@*/;
  /*@SWIG:%set_constant@*/ do {
    SV *sv = get_sv((char*) SWIG_prefix "SVN_RA_CAPABILITY_PARTIAL_REPLAY", TRUE | 0x2);
    sv_setsv(sv, SWIG_FromCharPtr("partial-replay"));
    SvREADONLY_on(sv);
  } while(0) /*@SWIG@*/;
  /*@SWIG:%set_constant@*/ do {
    SV *sv = get_sv((char*) SWIG_prefix "SVN_RA_CAPABILITY_COMMIT_REVPROPS", TRUE | 0x2);
    sv_setsv(sv, SWIG_FromCharPtr("commit-revprops"));
    SvREADONLY_on(sv);
  } while(0) /*@SWIG@*/;
  /*@SWIG:%set_constant@*/ do {
    SV *sv = get_sv((char*) SWIG_prefix "SVN_RA_ABI_VERSION", TRUE | 0x2);
