...
#if defined(OS2) || defined(__QNX__)
...
static	struct x_defbindings const x_defbindings[] = {
	...
	{ XFUNC_mv_back,		2,	'D'  },
#ifdef __QNX__
	/* people expect certain things on the keypad to work */
	{ XFUNC_meta2,			1,	'O'  },
	{ XFUNC_mv_begin,		2,	'H'  },
	{ XFUNC_mv_end,			2,	'w'  },
	{ XFUNC_mv_end,			2,	'Y'  },
	...
	/* 'qnx' terminal type */
	{ XFUNC_meta3,			0,	0xff },
	{ XFUNC_mv_begin,		3,	0xa0 },
	{ XFUNC_mv_end,			3,	0xa8 },
	{ XFUNC_del_char,		3,	0xac },
	{ XFUNC_mv_forw,		3,	0xa6 },
	{ XFUNC_mv_back,		3,	0xa4 },
	{ XFUNC_prev_com,		3,	0xa1 },
	{ XFUNC_next_com,		3,	0xa9 },
	{ XFUNC_mv_bword,		3,	0xb4 },
	{ XFUNC_mv_fword,		3,	0xb6 },
#endif
};
