 ...
 *
 * Revision 1.2  1999/08/05 18:46:14  adrianj
 * POSIXify utime.  Correct printf call for correct types.
 *
...
#ifndef lint
static char *ident = "$Id: buffer.c 153052 2008-08-13 01:17:50Z coreos $";
...
#endif
{
	...
	sprintf(header + M_STRLEN, H_PRINT, 0, 0,
		       0, 0, 0, 1, 0, (long unsigned)0, TRAILZ, (long unsigned)0);
