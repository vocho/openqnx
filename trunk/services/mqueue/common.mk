...
define PINFO
PINFO DESCRIPTION=POSIX message queue and named semaphore daemon
endef

EXTRA_CCDEPS = $(wildcard $(PROJECT_ROOT)/*.h)
CCFLAGS += -DMQUEUE_1_THREAD

INSTALLDIR=sbin

USEFILE=$(PROJECT_ROOT)/options.c
